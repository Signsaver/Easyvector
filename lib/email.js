          ...
          <tr>
            <td style="padding:36px;">
              ...
              <p style="color:#cccccc;font-size:14px;line-height:1.7;margin:0 0 24px;">
                Your <strong style="color:#de4426;">${planInfo.name} plan</strong> is now active and you have <strong style="color:#ffffff;">${planInfo.credits} credits</strong> ready to use.
              </p>
                ...
                <tr>
                  <td style="padding:20px;">
                    ...
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr><td style="padding:5px 0;"><span style="color:#de4426;font-size:14px;margin-right:10px;">2.</span><span style="color:#cccccc;font-size:14px;">Drag and drop your bitmap image (JPG, PNG, BMP, GIF, TIFF, WebP)</span></td></tr>
