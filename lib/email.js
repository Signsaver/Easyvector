...
export async function sendWelcomeEmail({ email, plan }) {
  const planInfo = PLAN_DETAILS[plan] || { name: 'your', credits: 0 };

  const creditsLine = planInfo.credits > 0
    ? `and you have <strong style="color:#ffffff;">${planInfo.credits} credits</strong> ready to use.`
    : `and your credits are ready to use.`;
    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background-color:#1a1a1a;border-radius:8px;overflow:hidden;max-width:600px;width:100%;">
          ...
          <!-- Header -->
          <tr>
            <td style="background-color:#1a1a1a;padding:24px 36px 20px;border-bottom:2px solid #de4426;">
              ${LOGO_SVG}
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px;">
              ...
              <p style="color:#cccccc;font-size:14px;line-height:1.7;margin:0 0 24px;">
                Your <strong style="color:#de4426;">${planInfo.name} plan</strong> is now active ${creditsLine}
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#252525;border-radius:6px;margin-bottom:28px;">
                <tr>
                  <td style="padding:20px;">
                    <p style="color:#de4426;font-size:12px;font-weight:bold;letter-spacing:1px;margin:0 0 14px;text-transform:uppercase;">Getting started</p>
                    <table cellpadding="0" cellspacing="0">
                      <tr><td style="padding:5px 0;"><span style="color:#de4426;font-size:14px;margin-right:10px;">1.</span><span style="color:#cccccc;font-size:14px;">Go to your <a href="https://easyvector.ai/dashboard" style="color:#e68734;text-decoration:underline;">dashboard</a></span></td></tr>
                      <tr><td style="padding:5px 0;"><span style="color:#de4426;font-size:14px;margin-right:10px;">2.</span><span style="color:#cccccc;font-size:14px;">Drag and drop your bitmap image (JPG, PNG, BMP, GIF, WebP)</span></td></tr>
                      <tr><td style="padding:5px 0;"><span style="color:#de4426;font-size:14px;margin-right:10px;">3.</span><span style="color:#cccccc;font-size:14px;">Choose your output format — SVG, PDF, EPS, or DXF</span></td></tr>
                      <tr><td style="padding:5px 0;"><span style="color:#de4426;font-size:14px;margin-right:10px;">4.</span><span style="color:#cccccc;font-size:14px;">Hit Trace Image and download your vector file</span></td></tr>
                    </table>
                  </td>
                </tr>
              </table>
